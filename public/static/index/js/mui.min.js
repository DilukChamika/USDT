...
var mui = function(a, b) {
    ...
    i.buffer = function(a, b, c) {
        ...
        return i.extend(function() {
            !f || g >= f && i.now() - g > b || g < f && i.now() - f > 8 * b ? d.apply(this, arguments) : (e && e.cancel(),
    ...
    i.each = function(a, b, c) {
        ...
        if ("number" == typeof a.length)
            ...
            for (var d in a)
                if (c) {
                    if (a.hasOwnProperty(d) && !1 === b.call(a[d], d, a[d]))
                        return a
                } else if (!1 === b.call(a[d], d, a[d]))
                    return a;
        return this
    }
    ,
...
function(a, b) {
    function c(c) {
        this.os = this.os || {},
        c.match(/Html5Plus/i) && (this.os.plus = !0,
        a(function() {
      ...
      , j = function(b, d, e, f) {
        return function(e) {
            ...
            a.each(h, function(b, c) {
                i = c.element;
                var f = i.tagName;
                if ("tap" === d && "INPUT" !== f && "TEXTAREA" !== f && "SELECT" !== f && (e.preventDefault(),
                e.detail && e.detail.gesture && e.detail.gesture.preventDefault()),
                a.each(c.handlers, function(b, c) {
                    a.each(c, function(a, b) {
                        !1 === b.call(i, e) && (e.preventDefault(),
                        e.stopPropagation())
                    }, !0)
                }, !0),
    ...
    b.addEventListener(a.EVENT_START, function(b) {
        for (var d = b.target, e = {}; d && d !== c; d = d.parentNode) {
            ...
            if (a.each(a.targetHandles, function(c, g) {
                var h = g.name;
                f || e[h] || !g.hasOwnProperty("handle") ? e[h] || !1 !== g.isReset && (a.targets[h] = !1) : (a.targets[h] = g.handle(b, d),
                a.targets[h] && (e[h] = !0,
                !0 !== g.isContinue && (f = !0)))
            }),
            f)
...
function() {
    ...
    void 0 === window.CustomEvent && (a.prototype = window.Event.prototype,
...
function(a, b, c) {
    if ((a.os.android || a.os.ios) && !b.FastClick) {
        var d = function(a, b) {
            ...
            !(!b || "radio" !== b.type && "checkbox" !== b.type || b.disabled) && b
        };
        a.registerTarget({
            name: c,
            index: 40,
        ...
        b.addEventListener("click", function(b) {
            if (a.targets.click && !b.forwardedTouchEvent)
                return b.stopImmediatePropagation ? b.stopImmediatePropagation() : b.propagationStopped = !0,
                b.stopPropagation(),
                b.preventDefault(),
                !1
        }, !0)
        ...
        case a.EVENT_MOVE:
            if (a.options.gestureConfig.pinch) {
                ...
                var g = d.scale
                  ...
                  , j = 1e-12;
                g > i ? (i = g - j,
                a.trigger(f.target, b + "out", d)) : g < i && (i = g + j,
    ...
    a.init = function(b) {
        ...
        a.ready(function() {
            a.doAction("inits", function(b, d) {
                !(c[d.name] && !d.repeat) && (d.handle.call(a),
                c[d.name] = !0)
            })
        }),
        this
...
function(a) {
    ...
    a.openWindow = function(b, f, g) {
        ...
        if (window.plus) {
            ...
            plus.webview.getWebviewById(f) && (k = l.webview)) : !0 !== g.createNew && (k = plus.webview.getWebviewById(f)),
            k)
                return h = l ? l.show : c,
    ...
    a.openWindowWithTitle = function(b, f) {
        ...
        if (window.plus) {
            ...
            plus.webview.getWebviewById(h) && (l = m.webview)) : !0 !== b.createNew && (l = plus.webview.getWebviewById(h)),
            l)
                return i = m ? m.show : c,
    ...
    a.createWindow = function(b, c) {
        if (window.plus) {
            var d, e = b.id || b.url;
            if (b.preload) {
                a.webviews[e] && a.webviews[e].webview.getURL() ? d = a.webviews[e].webview : (!0 !== b.createNew && (d = plus.webview.getWebviewById(e)),
                ...
                !1 !== c && (d = plus.webview.create(b.url, e, a.windowOptions(b.styles), b.extras),
                b.subpages && a.each(b.subpages, function(b, c) {
                    var e = c.id || c.url
...
function(a, b, c) {
    ...
    a.ajax = function(d, e) {
        ...
        if (r("X-Requested-With", "XMLHttpRequest"),
        r("Accept", m || "*/*"),
        (m = f.mimeType || m) && (m.indexOf(",") > -1 && (m = m.split(",", 2)[0]),
        t.overrideMimeType && t.overrideMimeType(m)),
        (f.contentType || !1 !== f.contentType && f.data && "GET" !== f.type.toUpperCase()) && r("Content-Type", f.contentType || "application/x-www-form-urlencoded"),
        f.headers)
            for (var w in f.headers)
                r(w, f.headers[w]);
        if (t.setRequestHeader = r,
        t.onreadystatechange = function() {
            if (4 === t.readyState) {
                t.onreadystatechange = a.noop,
                clearTimeout(u);
                var b, c = !1, d = "file:" === s;
                if (t.status >= 200 && t.status < 300 || 304 === t.status || 0 === t.status && d && t.responseText) {
                    ...
                    try {
                        "script" === h ? (0,
                        eval)(b) : "xml" === h ? b = t.responseXML : "json" === h && (b = i.test(b) ? null : a.parseJSON(b))
                    } catch (a) {
                        c = a
                    }
        ...
        for (var w in n)
            n.hasOwnProperty(w) && v.apply(t, n[w]);
    ...
    var e = "mui-scroll"
      ...
      , l = a.Class.extend({
            ...
            if (this.moved) {
                ...
                "dragend" !== b.type || !c.flick) {
                    ...
                    !this.resetPosition(this.options.bounceTime)) {
                        ...
                        d != this.x || e != this.y)
                            return (d > 0 || d < this.maxScrollX || e > 0 || e < this.maxScrollY) && (g = k.quadratic),
        ...
        resetPosition: function(a) {
            ...
            (b != this.x || c != this.y) && (this.scrollTo(b, c, a, this.options.scrollEasing),
            !0)
        },
        _reInit: function() {
    ...
    var e = "mui-visibility"
      ...
      , g = a.Scroll.extend(a.extend({
        ...
        pulldownLoading: function(a, b) {
            if (void 0 === a && (a = this.options.down.height),
    ...
    var c = "mui-slider"
      ...
      , l = a.Slider = a.Scroll.extend({
                ...
                if (m) {
                    ...
                    if (n.length > 0)
                        ...
                        if (o)
                            ...
                            for (var p = m.querySelectorAll(".mui-control-item"), g = 0, h = p.length; g < h; g++)
        ...
        _getPage: function(a, b) {
            ...
            time = 0) : a < (b ? -1 : 0) ? (a = this.itemLength - 2,
            time = 0) : a += 1 : (b || (a > this.itemLength - 1 ? (a = 0,
            time = 0) : a < 0 && (a = this.itemLength - 1,
            time = 0)),
        ...
        setTranslate: function(a, b) {
            this._super(a, b),
            this.progressBar && (this.progressBarStyle.webkitTransform = this._getTranslateStr(-a * (this.progressBarWidth / this.wrapperWidth), 0))
        },
        resetPosition: function(a) {
            return a = a || 0,
    ...
    a.fn.slider = function(b) {
        ...
        return this.each(function() {
            ...
            e && e.querySelector(j)) {
                ...
                f ? (d = a.data[f]) && b && d.refresh(b) : (f = ++a.uuid,
    ...
    a.os.plus && a.plusReady(function() {
        if (!1 !== window.__NWin_Enable__) {
            var c = "mui-visibility"
              ...
              , j = a.Class.extend({
                    ...
                    a.plusReady(function() {
                        if ("circle" == b.options.down.style)
                            ...
                            a.addEventListener("dragBounce", function(d) {
                                switch (b.pulldown ? b.pullPocket.classList.add(e) : b._initPulldownRefresh(),
                                d.status) {
                ...
                beginPullup: function(a) {
                    ...
                    !1 !== b.pulldown ? b._initPullupRefresh() : this.pullPocket.classList.add(e),
                    setTimeout(function() {
                ...
                endPullup: function(a) {
                    var e = this;
                    e.pullLoading && (e.pullLoading.classList.remove(c),
                    ...
                    window.removeEventListener("dragup", e)) : (e.pullCaption.className = f + " " + g,
            ...
            a.fn.pullRefresh_native = function(c) {
                var d;
                0 === this.length ? (d = b.createElement("div"),
                d.className = "mui-content",
                b.body.appendChild(d)) : d = this[0];
                var e = c;
                c = c || {},
                "string" == typeof c && (c = a.parseJSON(c)),
                !c.webviewId && (c.webviewId = plus.webview.currentWebview().id || plus.webview.currentWebview().getURL());
                var f = null
                  , g = c.webviewId && c.webviewId.replace(/\//g, "_")
                  , h = d.getAttribute("data-pullrefresh-plus-" + g);
                return !(!h && void 0 === e) && (h ? f = a.data[h] : (h = ++a.uuid,
                d.setAttribute("data-pullrefresh-plus-" + g, h),
                b.body.classList.add("mui-plus-pullrefresh"),
                a.data[h] = f = new j(d,c)),
                c.down && c.down.auto ? f.beginPulldown() : c.up && c.up.auto && f.beginPullup(),
                f)
            }
        }
    })
    ...
    var e = "mui-off-canvas-left"
      ...
      , m = a.Class.extend({
            ...
            case "dragend":
                if (this.isDragging) {
                    ...
                    if (this.slideIn) {
                        ...
                        "right" === d && e <= 0 && (e >= -.5 || c.swipe) ? this.openPercentage(100) : "right" === d && e > 0 && (e >= .5 || c.swipe) ? this.openPercentage(0) : "right" === d && e <= -.5 ? this.openPercentage(0) : "right" === d && e > 0 && e <= .5 ? this.openPercentage(-100) : "left" === d && e >= 0 && (e <= .5 || c.swipe) ? this.openPercentage(-100) : "left" === d && e < 0 && (e <= -.5 || c.swipe) ? this.openPercentage(0) : "left" === d && e >= .5 ? this.openPercentage(0) : "left" === d && e >= -.5 && e < 0 ? this.openPercentage(100) : this.openPercentage(0),
                        1 === e || -1 === e || 0 === e)
                            return void this._dispatchEvent()
                    } else {
                        if (0 === (e = f >= 0 ? this.offCanvasLeftWidth && f / this.offCanvasLeftWidth || 0 : this.offCanvasRightWidth && f / this.offCanvasRightWidth || 0))
                            return this.openPercentage(0),
                            void this._dispatchEvent();
                        "right" === d && e >= 0 && (e >= .5 || c.swipe) ? this.openPercentage(100) : "right" === d && e < 0 && (e > -.5 || c.swipe) ? this.openPercentage(0) : "right" === d && e > 0 && e < .5 ? this.openPercentage(0) : "right" === d && e < .5 ? this.openPercentage(-100) : "left" === d && e <= 0 && (e <= -.5 || c.swipe) ? this.openPercentage(-100) : "left" === d && e > 0 && (e <= .5 || c.swipe) ? this.openPercentage(0) : "left" === d && e < 0 && e >= -.5 ? this.openPercentage(0) : "left" === d && e > .5 ? this.openPercentage(100) : this.openPercentage(0),
        ...
        openPercentage: function(a) {
            ...
            this.offCanvasLeft.classList[0 !== a ? "add" : "remove"](j)) : this.offCanvasRight && a <= 0 && (b = 0 === b ? 1 : 0,
            ...
            this.offCanvasLeft.classList[0 !== b ? "add" : "remove"](j)) : this.offCanvasRight && a <= 0 && (this.updateTranslate(this.offCanvasRightWidth * b),
        ...
        show: function(a) {
            ...
            !this.isShown(a) && (a || (a = this.wrapper.querySelector("." + f) ? "right" : "left"),
...
function(a, b, c, d, e) {
    var f = "mui-control-item"
      ...
      , i = "mui-tab-item"
      , j = function(a, b) {
        return !(!b.classList || !b.classList.contains(f) && !b.classList.contains(i)) && (b.parentNode && b.parentNode.classList && b.parentNode.classList.contains(g) || a.preventDefault(),
        b)
    };
    a.registerTarget({
        name: d,
    ...
    var F = {
        ...
        drag: function(a) {
            if (e) {
                ...
                (A = e.querySelector(t)) && (sliderActionLeft = e.querySelector(u),
                ...
                var b = a.detail
                  , c = b.direction
                  , d = b.angle;
                if ("left" === c && (d > 150 || d < -150) ? (buttonsRight || buttonsLeft && isOpened) && (z = !0) : "right" === c && d > -30 && d < 30 && (buttonsLeft || buttonsRight && isOpened) && (z = !0),
                z) {
                    a.stopPropagation(),
                    a.detail.gesture.preventDefault();
                    ...
                    f < 0 ? sliderDirection = "toLeft" : f > 0 ? sliderDirection = "toRight" : sliderDirection || (sliderDirection = "toLeft"),
        ...
        dragend: function(b) {
            if (z) {
                ...
                (c.swipe || Math.abs(translateX) > f / 2) && (isOpened ? "left" === c.direction && "right" === openedActions ? d = "open" : "right" === c.direction && "left" === openedActions && (d = "open") : d = "open"),
                e.classList.add(s);
                var g;
                if ("open" === d) {
                    ...
                    void 0 !== (g = "toLeft" === sliderDirection ? buttonsRight : buttonsLeft)) {
                        for (var j = null, k = 0; k < g.length; k++)
                            j = g[k],
                            E(j, i);
                ...
                if (buttonsLeft && buttonsLeft.length > 0 && buttonsLeft !== g)
                    for (var k = 0, m = buttonsLeft.length; k < m; k++) {
                        var n = buttonsLeft[k];
                        l = n._buttonOffset,
                        void 0 === l && (n._buttonOffset = sliderActionLeftWidth - n.offsetLeft - n.offsetWidth),
                        E(n, l)
                    }
    ...
    var d = "mui-popup"
      ...
      , v = function(b, c, d, e, f) {
        if (void 0 !== b)
            ...
            e = d,
            d = null),
            a.os.plus && "div" !== f ? plus.nativeUI.alert(b, e, c || "提示", d || "确定") : u(s(b, c || "提示") + t([d || "确定"]), e)
    }
      , w = function(b, c, d, e, f) {
        if (void 0 !== b)
            ...
            e = d,
            d = null),
            a.os.plus && "div" !== f ? plus.nativeUI.confirm(b, e, c, d || ["取消", "确认"]) : u(s(b, c || "提示") + t(d || ["取消", "确认"]), e)
    }
      , x = function(b, c, d, e, f, g) {
        if (void 0 !== b)
            ...
            f = e,
            e = null),
            a.os.plus && "div" !== g ? plus.nativeUI.prompt(b, f, d || "提示", c, e || ["取消", "确认"]) : u(s(b, d || "提示", r(c)) + t(e || ["取消", "确认"]), f)
    }
      , y = function() {
      ...
      , i = function(h, i, j) {
        ...
        0 !== h.length) {
            ...
            if (h.classList.contains(c))
                ...
                l.className = c + " " + d + (void 0 !== i ? "" : " " + f) + (j ? " " + c + "-" + j : ""),
...
function(a, b, c) {
    var d = "mui-icon"
      ...
      , s = function(a, b) {
        ...
        ~this.options.actions.indexOf("slider") ? (this.sliderActionClass = j + " " + k,
        this.sliderActionSelector = q) : (~this.options.actions.indexOf("clear") && (this.clearActionClass = d + " " + e + " " + k,
        this.clearActionSelector = m),
        ~this.options.actions.indexOf("speech") && (this.speechActionClass = d + " " + f,
        this.speechActionSelector = n),
        ~this.options.actions.indexOf("search") && (this.searchActionClass = i,
        this.searchActionSelector = p),
        ~this.options.actions.indexOf("password") && (this.passwordActionClass = d + " " + g,
    ...
    s.prototype.createAction = function(a, b, e) {
        ...
        if (!f) {
            ...
            f.className = b,
            b === this.searchActionClass && (f.innerHTML = '<span class="' + d + ' mui-icon-search"></span><span>' + this.element.getAttribute("placeholder") + "</span>",
    ...
    a.fn.transparent = function(a) {
        ...
        return this.each(function() {
            ...
            if (!d) {
                ...
                null !== i && void 0 === a.scrollby && (a.scrollby = document.querySelector(i) || b),
