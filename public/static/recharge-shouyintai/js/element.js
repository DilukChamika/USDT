      ...
      , y = {
        tabClick: function(i, a, s, o) {
            ...
            var c = s || t(this)
              ...
              , d = c.find("a")
              , h = r.attr("lay-filter");
            "javascript:;" !== d.attr("href") && "_blank" === d.attr("target") || (c.addClass(l).siblings().removeClass(l),
        ...
        tabAuto: function() {
            ...
            t(".layui-tab").each(function() {
                ...
                if (n === window && 8 != a.ie && y.hideTabMore(!0),
        ...
        hideTabMore: function(i) {
            ...
            i !== !0 && "tabmore" === t(i.target).attr("lay-stope") || (a.removeClass("layui-tab-more"),
        ...
        clickThis: function() {
            ...
            i.find("." + d)[0] || ("javascript:;" !== s.attr("href") && "_blank" === s.attr("target") || c || (a.find("." + l).removeClass(l),
            i.addClass(l)),
            ...
            nav: function() {
                ...
                t(o + l).each(function(a) {
                    var l = t(this)
                      ...
                      , f = l.find("." + c);
                    l.find("." + r)[0] || (l.append(o),
                    f.on("mouseenter", function() {
                        v.call(this, o, l, a)
                    }).on("mouseleave", function() {
                        l.hasClass(u) || (clearTimeout(s[a]),
