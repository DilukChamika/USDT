...
!function(a, b, c) {
        ...
        return _createClass(c, [{
            ...
            value: function(a) {
                var b = this.opt.caseSensitive ? "" : "i"
                  , c = this.opt.caseSensitive ? ["aàáâãäåāąă", "AÀÁÂÃÄÅĀĄĂ", "cçćč", "CÇĆČ", "dđď", "DĐĎ", "eèéêëěēę", "EÈÉÊËĚĒĘ", "iìíîïī", "IÌÍÎÏĪ", "lł", "LŁ", "nñňń", "NÑŇŃ", "oòóôõöøō", "OÒÓÔÕÖØŌ", "rř", "RŘ", "sšśșş", "SŠŚȘŞ", "tťțţ", "TŤȚŢ", "uùúûüůū", "UÙÚÛÜŮŪ", "yÿý", "YŸÝ", "zžżź", "ZŽŻŹ"] : ["aÀÁÂÃÄÅàáâãäåĀāąĄăĂ", "cÇçćĆčČ", "dđĐďĎ", "eÈÉÊËèéêëěĚĒēęĘ", "iÌÍÎÏìíîïĪī", "lłŁ", "nÑñňŇńŃ", "oÒÓÔÕÖØòóôõöøŌō", "rřŘ", "sŠšśŚșȘşŞ", "tťŤțȚţŢ", "uÙÚÛÜùúûüůŮŪū", "yŸÿýÝ", "zŽžżŻźŹ"]
                  , d = [];
            ...
            value: function(a, c, d) {
                var e = this.opt.element ? this.opt.element : "mark"
                  ...
                  , g = f.splitText(d - c)
                  , h = b.createElement(e);
                return h.setAttribute("data-markjs", "true"),
                ...
                a.nodes.every(function(g, h) {
                    ...
                    if ("undefined" == typeof i || i.start > b) {
                        var j = function() {
                            ...
                            return g.node = f.wrapRangeInTextNode(g.node, i, j),
                            a.value = k + l,
                            a.nodes.forEach(function(b, c) {
                                c >= h && (a.nodes[c].start > 0 && c !== h && (a.nodes[c].start -= j),
                                a.nodes[c].end -= j)
                            }),
                            c -= j,
                            e(g.node.previousSibling, g.start),
                            c > g.end ? void (b = g.end) : {
                                v: !1
                            }
                        }();
                        if ("object" === ("undefined" == typeof j ? "undefined" : _typeof(j)))
                            return j.v
                    }
                    return !0
                })
            ...
            value: function(a) {
                if (a) {
                    if (3 === a.nodeType)
                        ...
                        this.normalizeTextNode(a.firstChild);
            ...
            value: function(a, b) {
                ...
                this[e](a, this.opt.ignoreGroups, function(a, b) {
                ...
                var d = 0
                  ...
                  , j = function a(b) {
                    ...
                    c[e](f, 1, function(a, e) {
                        ...
                        0 === j && c.opt.noMatch(b),
                        g[h - 1] === b ? c.opt.done(d) : a(g[g.indexOf(b) + 1])
                    })
                };
                this.opt.acrossElements && (e = "wrapMatchesAcrossElements"),
            ...
            value: function(a) {
                ...
                this.iterator.forEachNode(NodeFilter.SHOW_ELEMENT, function(a) {
                    b.unwrapMatches(a)
                }, function(a) {
                    var d = e.matches(a, c)
            ...
            key: "iterator",
            get: function() {
                return this._iterator || (this._iterator = new e(this.ctx,this.opt.iframes,this.opt.exclude,this.opt.iframesTimeout)),
                this._iterator
            }
        }]),
        c
      ...
      , e = function() {
        ...
        return _createClass(a, [{
            ...
            value: function() {
                var a = void 0
                  , c = [];
                return a = "undefined" != typeof this.ctx && this.ctx ? NodeList.prototype.isPrototypeOf(this.ctx) ? Array.prototype.slice.call(this.ctx) : Array.isArray(this.ctx) ? this.ctx : "string" == typeof this.ctx ? Array.prototype.slice.call(b.querySelectorAll(this.ctx)) : [this.ctx] : [],
            ...
            value: function(a, b, c) {
                var d = this
                  ...
                  , g = function g() {
                    if (!e) {
                        ...
                        clearTimeout(f);
                        try {
                            d.isIframeBlank(a) || (a.removeEventListener("load", g),
                ...
                f = setTimeout(g, this.iframesTimeout)
            }
        }, {
            key: "onIframeReady",
            value: function(a, b, c) {
    ...
    return c.fn.mark = function(a, b) {
        return new d(this.get()).mark(a, b),
        this
    }
    ,
    c.fn.markRegExp = function(a, b) {
        return new d(this.get()).markRegExp(a, b),
        this
    }
    ,
    c.fn.unmark = function(a) {
        return new d(this.get()).unmark(a),
        this
    }
    ,
    c
